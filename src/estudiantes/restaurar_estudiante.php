...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Panel de restauración de registros</p>
        </div>
        ...
        <div class="content">
            ...
            if ($conexion->query($sql) !== false) {
                echo "<div class='status success'>
                        <strong>¡Éxito!</strong> El estudiante ha sido restaurado correctamente.
                      </div>";
            } else {
        ...
        <a href="eliminados.php" class="btn btn-primary">Volver al listado de eliminados</a>
