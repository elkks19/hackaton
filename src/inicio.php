...
<body>
    ...
    <div class="container">
        <h1 class="main-title">Juegos</h1>
        
        <div class="dashboard">
            <a href="#" class="card" id="games-card" tabindex="0" aria-label="Sección de Juegos">
                <div class="card-image games-image"></div>
                <div class="card-content">
                    <h2 class="card-title">Aprender braille</h2>
                    <p class="card-desc">Aprende con practica lo principal de braile como el abecedario.</p>
                    <button class="card-button">Jugar</button>
                </div>
            </a>
            
            <a href="#" class="card" id="books-card" tabindex="0" aria-label="Juego de formas">
                <div class="card-image books-image"></div>
                <div class="card-content">
                    <h2 class="card-title">Juego de formas</h2>
                    <p class="card-desc">Reconoce formas usando el teclado</p>
                    <button class="card-button">Jugar</button>
                </div>
            </a>

            <a href="#" class="card" id="game2-card" tabindex="0" aria-label="Juego de formas">
                <div class="card-image books-image"></div>
                <div class="card-content">
                    <h2 class="card-title">Adivina la letra</h2>
                    <p class="card-desc">Adivina la letra en base al audio</p>
                    <button class="card-button">Jugar</button>
                </div>
            </a>
        </div>
    ...
    <script>
        ...
        document.getElementById('books-card').addEventListener('click', function(e) {
            if (e.target.tagName !== 'BUTTON') {
                ...
                window.location.href = 'juegosF/bienvenida.php';
            }
        });

        document.getElementById('game2-card').addEventListener('click', function(e) {
            if (e.target.tagName !== 'BUTTON') {
                // Aquí puedes agregar la navegación a la página de libros
                window.location.href = 'juegos/game_2.php';
            }
        });
