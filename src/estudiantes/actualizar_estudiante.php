...
<body>
    ...
    <div class="container">
        <header>
            <h1><i class="fas fa-user-edit"></i> Actualizar Estudiante</h1>
        </header>
        ...
        <form method="POST" action="">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="ci" name="ci" class="form-control" value="<?php echo $fila['ci']; ?>" required>
                </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="nombre_tutor" name="nombre_tutor" class="form-control" value="<?php echo $fila['nombre_tutor']; ?>" required>
            </div>
            
            <div class="form-row">
                <div class="form-group">
                    <label for="telefono_tutor">Teléfono del Tutor:</label>
                    <input type="text" id="telefono_tutor" name="telefono_tutor" class="form-control" value="<?php echo $fila['telefono_tutor']; ?>" required>
                </div>
                
                <div class="form-group">
                    <label for="ci_tutor">CI del Tutor:</label>
                    <input type="text" id="ci_tutor" name="ci_tutor" class="form-control" value="<?php echo $fila['ci_tutor']; ?>">
                </div>
            </div>
