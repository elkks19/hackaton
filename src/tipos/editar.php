...
$id = $_GET['id'];
$resultado = $conexion->query("SELECT * FROM tipos_materiales WHERE id = $id");
...
<body>
    <div class="header">
        ...
        <p>Formulario para editar un tipo de material existente</p>
    </div>

    <div class="container">
        <div class="card">
            <h2 class="form-title"><i class="fas fa-edit"></i> Editar Tipo</h2>
